...
<div class=" sm:shadow-none lg:shadow-2xl   container lg:w-[700px]  md:w-[700px] lg:m-0 md:m-0 mt-20 md:h-[9OOpx] lg:absolute md:absolute  md:top-[55%] md:container md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2    lg:top-[55%] lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:-translate-y-1/2   md:grid md:grid-cols-2      ">
  ...
  <div  class="  lg:h-max md:h-max  sm:h-full  py-5 lg:w-full  p-3   container flex flex-column justify-center align-center   " >
    ...
    <div>
      ...
      <input class="  rounded-2xl" type="checkbox"></input> Remember me <br></br>
      
      <div class="flex justify-center">
      <button class="my-2 py-1 px-8 text-white font-bold tracking-wide  bg-orangew rounded-xl " >Login</button>
    ...
    </div>   <h6  className=" font-semibold" >or</h6>
      <div class="flex justify-center flex-col">
        <button class="my-2 py-1 px-[71px] rounded-xl text-blue-500 border border-gray-400 "><i class="fa-brands fa-facebook"></i></button>
        <button class="my-2 py-1 px-[71px] rounded-xl  text-tomato   border border-gray-400 " ><i class="fa-brands  text-gmail fa-google"></i></button>
       </div>
